...
In the example notebook, the reader may click on a file comparable to the [example dataset](https://doi.org/10.5061/dryad.qnk98sfkv), which was used to generate the following receiver operator characteristic (ROC) traces:
